...
correct_prefix_initial_rho=${correct_prefix_initial_rho:-0.8}
correct_prefix_min_rho=${correct_prefix_min_rho:-0.0}
correct_prefix_max_rho=${correct_prefix_max_rho:-0.8}
correct_prefix_target_accuracy=${correct_prefix_target_accuracy:-0.8}
...
# GRPO schedule.
epoch=${epoch:-10000}
project_name=${project_name:-CorrectPrefix-Control-8B}
lr=${lr:-1e-6}
...
run_tag="rho${correct_prefix_initial_rho}-${correct_prefix_max_rho}_target${correct_prefix_target_accuracy}_alpha${correct_prefix_alpha}_window${correct_prefix_history_window}_slope${correct_prefix_slope_threshold}_${length_reward_tag}"
experiment_name=${experiment_name:-"grpo-correct-prefix-${model_name}-bsz${train_prompt_bsz}-k16-${run_tag}"}
