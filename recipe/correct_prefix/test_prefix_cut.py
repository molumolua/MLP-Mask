...
class PrefixCutTest(unittest.TestCase):
    ...
    def test_token_strategy_preserves_legacy_floor_cut(self):
        result = cut_correct_solution_prefix(self.tokenizer, "abcdefghij", 0.29, "token")
    ...
    def test_line_strategy_rounds_to_nearest_complete_line(self):
        ...
        first_line = cut_correct_solution_prefix(self.tokenizer, text, 0.2, "line")
        second_line = cut_correct_solution_prefix(self.tokenizer, text, 0.7, "line")
    ...
    def test_line_strategy_breaks_equal_distance_tie_toward_shorter_prefix(self):
        ...
        result = cut_correct_solution_prefix(self.tokenizer, text, 10 / 15, "line")
    ...
    def test_line_strategy_falls_back_to_token_cut_for_single_line(self):
        result = cut_correct_solution_prefix(self.tokenizer, "abcdefghij", 0.2, "line")
    ...
    def test_line_strategy_preserves_windows_line_ending(self):
        ...
        result = cut_correct_solution_prefix(self.tokenizer, text, 0.3, "line")
    ...
    def test_rejects_unknown_strategy(self):
        with self.assertRaisesRegex(ValueError, "must be 'token' or 'line'"):
            cut_correct_solution_prefix(self.tokenizer, "abc\ndef", 0.2, "sentence")
