...
--------
    ...
    python recipe/denoise/fix_system_prompt_capitalization.py --dry-run

    # Update the repository's data directory in place.
    python recipe/denoise/fix_system_prompt_capitalization.py

    # Update one file or a different data directory.
    python recipe/denoise/fix_system_prompt_capitalization.py /path/to/data
"""
