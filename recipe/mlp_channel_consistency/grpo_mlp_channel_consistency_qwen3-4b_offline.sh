...
score_method=${score_method:-none}
score_ema_beta=${score_ema_beta:-0.0}
activation_ema_beta=${activation_ema_beta:-0.95}
relative_activation_epsilon=${relative_activation_epsilon:-1.0e-6}
...
experiment_name=${experiment_name:-"grpo-${model_name}-hardmask${mask_ratio}-${selection_strategy}-${score_method}-kl${kl_coef}-top${kl_top_k}"}
...
"${python_bin}" -m recipe.mlp_channel_consistency.main \
    ...
    actor_rollout_ref.mlp_channel_consistency.selection_strategy=${selection_strategy} \
    actor_rollout_ref.mlp_channel_consistency.score_method=${score_method} \
    actor_rollout_ref.mlp_channel_consistency.score_ema_beta=${score_ema_beta} \
    actor_rollout_ref.mlp_channel_consistency.activation_ema_beta=${activation_ema_beta} \
    actor_rollout_ref.mlp_channel_consistency.relative_activation_epsilon=${relative_activation_epsilon} \
    actor_rollout_ref.mlp_channel_consistency.weighted_max_ratio=${weighted_max_ratio} \
    actor_rollout_ref.mlp_channel_consistency.weighted_rank_power=${weighted_rank_power} \
    ...
    actor_rollout_ref.mlp_channel_consistency.parameter_update_diagnostics_enabled=${parameter_update_diagnostics_enabled} \
