...
project_name=${project_name:-MLP-Channel-Consistency-4B}
experiment_name=${experiment_name:-"grpo-${model_name}-hardmask${mask_ratio}-kl${kl_coef}-top${kl_top_k}"}
...
"${python_bin}" -m recipe.mlp_channel_consistency.main \
