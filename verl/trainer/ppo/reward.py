...
def compute_reward(data: DataProto, reward_fn: AbstractRewardManager,rollout_save_path:str|None = None) -> tuple[torch.Tensor, dict[str, Any]]:
    """
    ...
    """
    try:
        reward_result = reward_fn(data, return_dict=True,rollout_save_path=rollout_save_path)
